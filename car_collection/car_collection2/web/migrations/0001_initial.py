# Generated by Django 4.2 on 2023-06-05 20:12

import car_collection2.web.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(validators=[car_collection2.web.models.validate_year])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('username', models.CharField(max_length=10, validators=[car_collection2.web.models.validate_username])),
